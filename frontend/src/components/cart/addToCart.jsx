...
const AddToCart = ({ id }) => {
    ...
    return (
        <div className='flex flex-col  m-auto items-center'>
            ...
            <button className=' flex text-base rounded-full m-auto w-4/5 justify-center p-2 border-2 border-primary  bg-primary hover:bg-yellow-700 hover:border-yellow-700 hover:text-white' onClick={handleAddToCart}>Add to Cart</button>
