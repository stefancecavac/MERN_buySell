    ...
    return (
        <div className='m-auto mt-24 w-4/12 shadow rounded bg-main '>
            <form className=' flex flex-col' onSubmit={loginUser}>
                <h1 className='m-10 text-5xl text-primary'>Login</h1>
                ...
                <p className='m-auto mt-2 text-white'>Dont have a account<Link className='text-primary' to='/register'> Register here</Link></p>
                <button className='bg-primary rounded my-5 mx-24 py-2 text-white hover:bg-yellow-700 transition-all' type="submit">Login</button>
